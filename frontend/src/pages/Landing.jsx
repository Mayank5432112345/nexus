          ...
          <div style={{ 
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                <a href="mailto:mayankkatnoria518@gmail.com" style={{
                  color: '#9ca3af',
                  textDecoration: 'none',
                  fontSize: '0.875rem',
                  transition: 'all 0.3s ease',
                  ...
                  <Mail size={16} />
                  <span>mayankkatnoria518@gmail.com</span>
                </a>
              </div>
            </div>
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                <a
                  href="https://github.com/Mayank5432112345"
                  target="_blank"
                ...
                >
                  <Github size={16} />
                  <span>github.com/Mayank5432112345</span>
                </a>

                <a
                  href="https://www.linkedin.com/in/mayank-katnoria"
                  target="_blank"
                  rel="noopener noreferrer"
                  style={{
                    color: '#9ca3af',
